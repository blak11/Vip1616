...
manglist = requests.get('https://raw.githubusercontent.com/blak11/.txt/main/list.txt')
idd = manglist.text
...
hala = '\x1b[31;1m{1} >\x1b[0;1m Write Id And It Will Hack it \n      without cp ( \x1b[92mkorak\x1b[0;1m ,\x1b[33;1m TP-Link \x1b[0;1m)\n\x1b[31;1m{0} >\x1b[0;1m Darchwn la\x1b[31;1m Program\x1b[0;1m'
...
def menu():
    ...
    print '\x1b[32m.'
    os.system('clear')
    os.system('figlet Toll VIP 1616')
    print 'Chenall telegram: https://t.me/Robot1616'
    print 48*'\033[92m-\033[90m'
    print hala
    print 48*'\033[92m-\033[90m'
    action()
...
def action():
    bch = raw_input(' Code : ')
    if bch == '':
        os.system('python2 VIP1616.py')
        print ' halaya !'
        action()
    elif bch == '':
        os.system('python2 VIP1616py')
    elif bch == '1':
        os.system('clear')
        print '\x1b[32m.'
        os.system('clear')
        ...
        try:
            k = '+964'
            c = raw_input('\x1b[90;1m Code Dane  : ')
            idlist = '.txt'
    ...
    xxx = str(len(id))
    print 48*'\033[92m-\033[90m'
    psb('\x1b[31m Created Number All Iraq  : ' + xxx)
    print ' Created Chawa rwanba     : 15:00 '
    print ' Created Crack Fb Iraq    : Number '
    print ' Created Crack Bowastandn : CTRLz '
    print 48*'\033[92m-\033[90m'
    def main(arg):
        user = arg
        try:
...
for s in idd.split():
    ...
    bani = '  \n  Bo Active Krdni Tool Ka\n\n           Nama Bnera Bo Telegram @Robot16_16\n'
    print bani
    print '       ID To Amaya ===> ' + sp[0]
    print '\x1b[90;1m\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\x1b[0;1m\n\n\n'
    time.sleep(2)
    os.system('xdg-open https://t.me/@Robot16_16')
    os.sys.exit()